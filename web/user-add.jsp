<%-- 
    Document   : user-add
    Created on : Jun 18, 2024, 6:52:18 PM
    Author     : ACER
--%>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <select class="form-control form-control-line">
                                            <%
                                                List<RoleEntity> roleList = (List<RoleEntity>) request.getAttribute("roles");
                                                for (RoleEntity roleEntity : roleList) {
                                            %>
                                            <option name ="roles" value="<%= roleEntity.getId()%>"><%= roleEntity.getName() %></option>
                                            <%
                                                }
                                            %>
                                        </select>
